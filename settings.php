<?php
define('C_REST_CLIENT_ID','local.679750dd475545.02919377');//Application ID
define('C_REST_CLIENT_SECRET','otjDs0BqoZIf654RLj1sKiktWAnSF9qelgdzojstDChN6C9Cpm');//Application key
// or
